...
export class APIService {
    ...
    public async importSchema() {
        let schema = [
            ...
            "CREATE TABLE IF NOT EXISTS ROOM (ID VARCHAR(255) PRIMARY KEY UNIQUE, MAC_ID VARCHAR(255) UNIQUE, NAME VARCHAR(255) UNIQUE, USER_ID VARCHAR(255) NOT NULL, FOREIGN KEY(USER_ID) REFERENCES User(ID));",
